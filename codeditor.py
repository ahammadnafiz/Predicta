...
class PredictaCodeEditor:
    ...
    def run_code_editor(self, df):
        ...
        response_dict = code_editor(self.demo_sample_python_code, height=height, lang=language, buttons=self.custom_buttons_alt, info=self.info_bar)
